...
<div class="main-header">
    ...
    <p>Tác giả: Trần Thị Nhung - Trường tiểu học Tân Loan - ĐT: 0965968885 </p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Trần Thị Nhung - Trường tiểu học Tân Loan - ĐT: 0965968885</div>", unsafe_allow_html=True)
